...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-2 px-1 bg-dark position-fixed" id="sticky-sidebar">
            <div class="nav flex-column flex-nowrap vh-100 overflow-auto text-white p-2">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="message.php" class="nav-link bg-light text-dark" aria-current="page">
                            <svg class="bi me-2" width="16" height="16">
                                <use xlink:href="#table"/>
                            </svg>
                            Inbox
        ...
        <div class="col-10 offset-2" id="main">
            ...
            <form method="post" action="controller/message_delete.php">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-7 offset-1">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <small class="text-muted">{$message.sender}</small>
                                        <small class="text-dark mx-3">{$message.email}</small>
                                    </p>
                                    <p class="card-text">
